...
<h2 class="page-header">编辑博客</h2>
<form action="<?php echo url('ni/blog/edit'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	  	<?php if($data['image']): ?>
		<img src="/xuexi/18_News/Day_06/code/tp5/public/static/upload/<?php echo $data['image']; ?>" class="img-thumbnail">
	  	<?php endif; ?>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	    <textarea name="content" class="form-control" cols="30" rows="5"><?php echo $data['content']; ?></textarea>
	  </div>
	  <div class="col-md-5">
