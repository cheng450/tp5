<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"D:\WWW\xuexi\18_News\Day_06\code\tp5\public/../application/admin\view\category\edit.html";i:1529662096;s:76:"D:\WWW\xuexi\18_News\Day_06\code\tp5\application\admin\view\public\base.html";i:1529551766;s:78:"D:\WWW\xuexi\18_News\Day_06\code\tp5\application\admin\view\public\topnav.html";i:1529568370;s:79:"D:\WWW\xuexi\18_News\Day_06\code\tp5\application\admin\view\public\leftnav.html";i:1530153684;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<form action="<?php echo url('admin/category/edit'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	  	<select name="pid" class="form-control">
			...
			<option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $data['pid']): ?>selected="selected"<?php endif; ?>><?php echo str_repeat('--', $vo['level']); ?> <?php echo $vo['title']; ?></option>
