	...
	<table class="table table-condensed table-hover table-bordered table-striped">
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo url('ni/category/edit',['id' => $vo['id']]); ?>" class="btn btn-primary">编辑</a>
			</td>
		</tr>
