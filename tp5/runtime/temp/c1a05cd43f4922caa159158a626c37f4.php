<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\www\18_News\Day_06\code\tp5\public/../application/admin\view\news\edit.html";i:1530174763;s:70:"D:\www\18_News\Day_06\code\tp5\application\admin\view\public\base.html";i:1529551765;s:72:"D:\www\18_News\Day_06\code\tp5\application\admin\view\public\topnav.html";i:1529568368;s:73:"D:\www\18_News\Day_06\code\tp5\application\admin\view\public\leftnav.html";i:1530153683;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<form action="<?php echo url('admin/news/doEdit'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	  	<select name="cid" class="form-control">
			...
			<option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $data['cid']): ?>selected="selected"<?php endif; ?>><?php echo str_repeat('--', $vo['level']); ?> <?php echo $vo['title']; ?></option>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	    <textarea name="content" id="container" rows="5"><?php echo $data['content']; ?></textarea>
	  </div>
	  <div class="col-md-5">
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	  	<?php if($data['image']): ?>
		<img src="/18_News/Day_06/code/tp5/public/static/upload/<?php echo $data['image']; ?>" class="img-thumbnail">
	  	<?php endif; ?>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	    <input type="checkbox" name="recommend" value="1" <?php if($data['recommend'] == 1): ?>checked="checked"<?php endif; ?>> 推荐
	  </div>
	  <div class="col-md-5">
	    <span class="help-block"></span>
	  </div>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	    <input type="checkbox" name="online" value="1" <?php if($data['online'] == 1): ?>checked="checked"<?php endif; ?> > 上线
	  </div>
	  <div class="col-md-5">
	    <span class="help-block"></span>
	  </div>
